...
ActiveRecord::Schema.define(:version => 20140708043155) do
  ...
  create_table "compuerta_cierres", :force => true do |t|
    t.string   "nombre"
    t.integer  "tipo"
    t.integer  "my_js_tree_id"
    t.integer  "proceso_id"
  ...
  create_table "merge_compuertas", :force => true do |t|
    t.integer  "proceso_id"
    t.string   "ruta_id"
    t.integer  "plantilla_id"
    t.integer  "merge_id"
