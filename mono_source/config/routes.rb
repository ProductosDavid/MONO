CMS::Application.routes.draw do
  ...
  match '/reporte/:id_proyecto/proyecto' => 'reporte#proyecto'
  match '/reporte/:id_proceso/procesos' => 'reporte#procesos'
  ...
  match '/merges/:id/destroy' => 'merges#destroy', :as => :destroy
  match '/loops/:id/destroy' => 'loops#destroy', :as => :destroy


  match '/actividads/:id/updateName' => 'actividads#updateName', :as => :update
  match '/actividads/:id/updateType' => 'actividads#updateType', :as => :update
  match '/compuertus/:id/updateName' => 'compuertus#updateName', :as => :update
  match '/compuertus/:id/updateType' => 'compuertus#updateType', :as => :update

  match '/loops/:id/updateName' => 'loops#updateName', :as => :updateName
  ...
  match '/procesos/:id/get_optimizar' => 'procesos#get_optimizar', :as => :get_optimizar
  match '/procesos/:id_proceso/crear_procesoopt' => 'procesos#crear_procesoopt', :as => :crear_procesoopt
  match '/procesos/:id_proceso/crear_procesooptimi' => 'procesos#crear_procesooptimi', :as => :crear_procesooptimi
  ...
  #match '/procesos/:id_proceso/reporte' => 'procesos#reporte', :as => :reporte
  match '/procesos/:id_proceso/xpdl' => 'procesos#GenerateXPDL', :as => :GenerateXPDL
  match '/plantillas/:id_plantilla/xpdl' => 'plantillas#GenerateXPDL', :as => :GenerateXPDL
  ...
  match '/calendarios/:id_calendario/actualizar_calendario' => 'calendarios#actualizar_calendario', :as => :actualizar_calendario
  ...
  match '/tipo_artefacto/:id/get_tipo_artefacto' => 'tipo_artefactos#get_tipo_artefacto', :as => :get_tipo_artefacto
  match '/tipo_plantilla/:id/get_tipo_plantilla' => 'tipo_plantillas#get_tipo_plantilla', :as => :get_tipo_plantilla
  match '/tipo_organizacion/:id/get_tipo_organizacion' => 'tipo_organizacions#get_tipo_organizacion', :as => :get_tipo_organizacion
  match '/tipo_recurso/:id/get_tipo_recurso' => 'tipo_recursos#get_tipo_recurso', :as => :get_tipo_recurso
  match '/organizacion/:id/get_organizacion' => 'organizacions#get_organizacion', :as => :get_organizacion
  match '/plantilla/:id/get_plantilla' => 'plantillas#get_plantilla', :as => :get_plantilla
  match '/usuario/:id/get_usuario' => 'usuarios#get_usuario', :as => :get_usuario
  match '/usuarios/:id/pruebausuarios' => 'usuarios#pruebausuarios', :as => :pruebausuarios
  match '/recurso/:id/get_recurso' => 'recursos#get_recurso', :as => :get_recurso
  match '/proyecto/:id/get_proyecto' => 'proyectos#get_proyecto', :as => :get_proyecto
  match '/recurso/deshabilitar' => 'recursos#deshabilitar', :as => :deshabilitar
  match '/recurso/deshabilitarg' => 'recursos#deshabilitarg', :as => :deshabilitarg
  match '/usuario/deshabilitar' => 'usuarios#deshabilitar', :as => :deshabilitar
  match '/usuario/deshabilitarg' => 'usuarios#deshabilitarg', :as => :deshabilitarg
  match '/recurso/habilitarvista' => 'recursos#habilitarvista', :as => :habilitarvista
