...
function Datepicker() {
	...
	this.regional[''] = { // ES/Spanish
		...
		prevStatus: 'Mostrar el mes anterior', // Status text for the previous month command
		prevJumpText: '&lt;&lt;', // Text for the previous year command
		prevJumpStatus: 'Mostrar el año anterior', // Status text for the previous year command
		nextText: 'Sig&gt;', // Text for the next month command
		nextStatus: 'Mostrar el siguiente mes', // Status text for the next month command
		nextJumpText: '&gt;&gt;', // Text for the next year command
		nextJumpStatus: 'Mostrar el siguiente año', // Status text for the next year command
		currentText: 'Actual', // Text for the current month command
		currentStatus: 'Mostrar el mes actual', // Status text for the current month command
		todayText: 'Hoy', // Text for the today's month command
		todayStatus: 'Mostrar el mes de hoy', // Status text for the today's month command
		clearText: 'Limpiar', // Text for the clear command
		clearStatus: 'Limpiar la fecha', // Status text for the clear command
		closeText: 'Cerrar', // Text for the close command
		closeStatus: 'Cerrar el datepicker', // Status text for the close command
		...
		dayStatus: 'Elegir DD, M d, yyyy', // Status text for selectable days
