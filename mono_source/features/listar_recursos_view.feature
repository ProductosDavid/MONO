...
Característica: Listar Recursos
  ...
  Esquema del escenario: Listar recursos
    Dado que en recursos estoy en la pagina <pagina>
    Y en recursos he introducido <recurso_1>
    Y en recursos vuelvo a <pagina>
    Entonces se espera en recursos ver <resultado1>
