...
class TipoRecursosTest < ActionDispatch::IntegrationTest
  ...
  def test_group_tests
    ...
    assert_equal cantTrmI + 4, cantTrmF
    #FIN creacion tipo recursos materiales

    #INI creacion tipo recursos humanos
    cantTrhI = TipoRecurso.where(:unit => '1').all.count
    tipo_recursoh = @usuarioApp.create_tipo_recurso_humano("5")
    tipo_recursoh2 = @usuarioApp.create_tipo_recurso_humano("6")
    tipo_recursoh3 = @usuarioApp.create_tipo_recurso_humano("7")
    tipo_recursoh4 = @usuarioApp.create_tipo_recurso_humano("8")
    tipo_recursoh5 = @usuarioApp.create_tipo_recurso_humano("9")
    cantTrhF = TipoRecurso.where(:unit => '1').all.count
    assert_equal cantTrhI + 5, cantTrhF
    ...
    assert_equal cantToI + 4, cantToF
    ...
    assert_equal cantTpI + 5, cantTpF
    ...
    usuario6 = @usuarioApp.create_usuario("6",tipo_recursoh.id,"3")
    usuario7 = @usuarioApp.create_usuario("7",tipo_recursoh.id,"3")
    usuario8 = @usuarioApp.create_usuario("8",tipo_recursoh.id,"3")
    usuario9 = @usuarioApp.create_usuario("9",tipo_recursoh.id,"3")
    cantUF = Usuario.all.count
    assert_equal cantUI + 9, cantUF
    ...
    #INI generar un XPDL de un proceso (proceso)
    @usuarioApp.generarXPDL(proceso.id)
    @usuarioApp.generarXPDL(proceso2.id)
    @usuarioApp.generarXPDL(proceso3.id)
    @usuarioApp.generarXPDL(proceso4.id)
    @usuarioApp.generarXPDL(proceso5.id)
    #FIN generar un XPDL de un proceso (proceso)
  ...
  module BrowsingTestDSL
    ...
    def generarXPDL(idProceso)
      get "/procesos/" + idProceso.to_s + "/xpdl"
      assert_equal 200, status
    end
